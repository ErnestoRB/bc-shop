		...
		<div class="ContentForm">
			<form action="" method="post" name="FormEntrar">
				<div class="input-group input-group-lg">
					<span class="input-group-addon bfondo" id="sizing-addon1" style="padding-right:4px; padding-left:4px;"> <button style="margin-left: 0px;" type="button" class="btn btn-default btncapt"><i class="glyphicon glyphicon-refresh"></i></button> </span>
				...
				<br>
				<button class="btn btn-lg btn-color btn-block btn-signin" id="IngresoLog" type="button">Entrar</button>

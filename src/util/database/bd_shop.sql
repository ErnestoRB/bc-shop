...
INSERT INTO `users` (`idusuario`, `nombre`, `apellidos`, `cuenta`, `contraseña`, `correo`, `bloqueo`) VALUES
(1, 'Gandhi Arturo', 'Cabral Villarreal', 'Gandhi0101', 'qwerty', 'gandhi2000@hotmail.com', 1),
(3, 'Gandhi Arturo', 'Cabral Villarreal', 'Gandhi0101', 'd8578edf8458ce06fbc5bb76a58c5ca4', 'gandhi2000@outlook.com', 1);
...
ALTER TABLE `users`
  ...
  ADD UNIQUE KEY `Email_2` (`correo`),
  ADD UNIQUE KEY `Email_3` (`correo`),
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`id_categoría`) REFERENCES `categoria` (`idCategoria`) ON UPDATE CASCADE;
